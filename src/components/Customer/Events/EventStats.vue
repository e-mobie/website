...
<span>
    <b-container>
      <b-card class="m-3" title="Statistics" :sub-title="eventObj.title">
        ...
        <b-button variant="outline-warning" size="sm" @click="openRTGuestList">Realtime Guest List (Beta)</b-button>
        <hr />
        <h4>Tickets</h4>
        <b-list-group>
...
export default {
  ...
  methods: {
    ...
    openRTGuestList: function() {
      this.$refs.realtimeGuestList.show()
    }
  }
}
</script>
