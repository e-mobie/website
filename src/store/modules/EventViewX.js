...
export default {
  ...
  mutations: {
    ...
    addPublishedEvent (state, eventObject) {
      state.publishedEvents.push(eventObject)
    },
    removePublishedEvent (state, eventId) {
      state.publishedEvents.splice(state.publishedEvents.findIndex((element) => {
  ...
  actions: {
    ...
    addToPublishedEvents (context, eventObj) {
      context.commit('addPublishedEvent', eventObj.redis.data)
    },
    removePublishedEvent (context, eventId) {
      context.commit('removePublishedEvent', eventId)
    }
  },
